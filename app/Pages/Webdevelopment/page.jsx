        ...
        <div class="bg-white dark:bg-gray-800 pt-20 " id="pricing">
          <div class="relative mx-auto max-w-7xl px-6 text-center lg:px-8 mb-10">
            <div class="mx-auto max-w-2xl lg:max-w-4xl">
              ...
              <p class="mt-2 text-[30px] font-bold tracking-tight text-gray-900 dark:text-gray-200">Find the right plan for your project</p>
            </div>
          </div>
            ...
            <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
              <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-7xl lg:grid-cols-3 lg:gap-8">
                ...
                <div class="flex flex-col rounded-3xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-black/10">
                  <div class="p-8 sm:p-10">
                    <div class="flex">
                      <h3 class="text-lg font-semibold leading-8 tracking-tight text-teal-600 dark:text-teal-400" id="tier-plus">Advanced
                      </h3>
                ...
                <div class="flex flex-col rounded-3xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-black/10">
                  <div class="p-8 sm:p-10">
                    <div class="flex">
                      <h3 class="text-lg font-semibold leading-8 tracking-tight text-teal-600 dark:text-teal-400" id="tier-custom">Premium</h3>
                      <div class="items-center ml-2"></div>
                    </div>
